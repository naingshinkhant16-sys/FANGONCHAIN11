      ...
      <header className="relative z-40 border-b border-[rgba(143,227,138,0.18)] bg-[#081410]/90 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7 font-display text-xs font-bold uppercase tracking-widest text-[#a39d8c]">
            <a href="#about-section" className="hover:text-[#8fe38a] transition-colors">Ecosystem</a>
            <a href="#bush-mint-section" className="hover:text-[#8fe38a] transition-colors">Portal</a>
            <a href="#whitelist-section" className="hover:text-[#8fe38a] transition-colors text-[#e05a3a]">Trail List</a>
            <a href="#sneak-peak-section" className="hover:text-[#8fe38a] transition-colors">Gallery</a>
            <a href="#roadmap-section" className="hover:text-[#8fe38a] transition-colors">Map</a>
          </nav>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <a href="#about-section" onClick={() => setIsMobileMenuOpen(false)} className="block py-2 text-[#ece6d6] hover:text-[#8fe38a]">Ecosystem</a>
            <a href="#bush-mint-section" onClick={() => setIsMobileMenuOpen(false)} className="block py-2 text-[#ece6d6] hover:text-[#8fe38a]">Portal</a>
            <a href="#whitelist-section" onClick={() => setIsMobileMenuOpen(false)} className="block py-2 text-[#e05a3a] hover:text-[#8fe38a]">Trail List</a>
            <a href="#sneak-peak-section" onClick={() => setIsMobileMenuOpen(false)} className="block py-2 text-[#ece6d6] hover:text-[#8fe38a]">Gallery</a>
            <a href="#roadmap-section" onClick={() => setIsMobileMenuOpen(false)} className="block py-2 text-[#ece6d6] hover:text-[#8fe38a]">Map</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-left font-display">
              ...
              <h2 className="font-black text-3xl md:text-5xl text-[#ece6d6] tracking-wide leading-none uppercase">Genesis FANG Gallery</h2>
            </div>
            <p className="text-[#a39d8c] text-xs md:text-sm font-mono max-w-sm leading-relaxed mt-4 md:mt-0 text-left">
              Hover over or touch each specimen to trigger real-time glitch aberration split-layer effects.
            </p>
          </motion.div>

          {/* Glitch Grid of 4 Image Spaces (2 in a row on mobile view) */}
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false, margin: "-50px" }}
